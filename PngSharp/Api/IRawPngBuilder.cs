...
public interface IRawPngBuilder
{
    ...
    IRawPngBuilder WithTxtChunk(TxtChunkData textChunk);
    IRawPngBuilder WithZTxtChunk(ZTxtChunkData textChunk);
    IRawPngBuilder WithITxtChunk(ITxtChunkData textChunk);
    IRawPng Build();
}
